        ...
        while(!al_is_event_queue_empty(fila_eventos)){
            ...
            /* Ou se o evento foi um clique do mouse */
                ...
                if (evento.mouse.x >= 1250 &&
                    ...
                    evento.mouse.y >= 200 &&
                    evento.mouse.y <= 300){
                    al_play_sample(lobo.som, 1.0, 0.0, 1.0, ALLEGRO_PLAYMODE_ONCE, lobo.id);
                }
            }
            ...
            /* Animais */
            al_draw_bitmap(sapo.imagem, 0, 0, 0);  
            al_draw_bitmap(cobra.imagem, 450, 0, 0);
            al_draw_bitmap(galo.imagem, 0, 390, 0);
            al_draw_bitmap(lobo.imagem, 450, 390, 0);
